            ...
            <div class="cart-item">
                ...
                <div class="cart-item-actions">
                    <div class="d-flex align-items-center gap-2">
                        <button class="btn btn-sm btn-outline-secondary" onclick="decrementarDelCarrito(${producto.id})" title="Quitar uno">−</button>
                        <span class="fw-bold fs-6">${producto.cantidad}</span>
                        <button class="btn btn-sm btn-outline-primary" onclick="incrementarEnCarrito(${producto.id})" title="Agregar uno">+</button>
                        <button class="btn btn-sm btn-outline-danger ms-1" onclick="eliminarDelCarrito(${producto.id})" title="Eliminar producto">
...
// ============================================
function incrementarEnCarrito(id) {
...
// ============================================
function decrementarDelCarrito(id) {
    const producto = carrito.find(p => p.id === id);
    if (producto) {
        if (producto.cantidad > 1) {
            producto.cantidad--;
...
window.incrementarEnCarrito = incrementarEnCarrito;
window.decrementarDelCarrito = decrementarDelCarrito;